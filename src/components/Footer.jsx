  ...
  return (
    <>
      <div className="container-fluid  text-light" style={{background:'black',padding:'60px' }}>
        ...
        <div className="container d-lg-flex  justify-content-between my-5">
          <div>
          <FontAwesomeIcon className=" me-lg-5 me-3 ms-lg-0 ms-0 fs-5" icon={faFacebook} />
          <FontAwesomeIcon className=" me-lg-5 me-3 ms-lg-0 ms-3 fs-5" icon={faX} />
          <FontAwesomeIcon className=" me-lg-5 me-3 ms-lg-0 ms-3 fs-5" icon={faYoutube} />
          <FontAwesomeIcon className=" me-lg-5 me-3 ms-lg-0 ms-3 fs-5" icon={faLinkedin} />
          <FontAwesomeIcon className=" me-lg-5 me-3 ms-lg-0 ms-3 fs-5" icon={faInstagram} />
          </div>
          ...
          <div className="container">
            ...
            <button className="ms-lg-2 ms-0"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Download_on_the_App_Store_Badge.svg/2560px-Download_on_the_App_Store_Badge.svg.png" style={{height:'40px'}} alt="" /></button>
          </div>
